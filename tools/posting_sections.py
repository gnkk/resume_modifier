...
# of the patterns above match. Those are recognized structurally instead:
# a short, punctuation-free line sitting alone above a block of text.
# Requiring a blank line before and content immediately after is what
# keeps ordinary short sentences from being promoted to headings.
_BARE_HEADING_RE = re.compile(r"^[A-Z][A-Za-z0-9 &/'\u2019\-]{2,58}$")

# Ranked by how much the section matters to "would this person be
# screened out". Matched against the heading text, lowercased.
