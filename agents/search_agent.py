...
Output is structured JSON so the writer/judge downstream get a clean,
...
target location or remote status) rather than one generic query.
...
def find_best_job(candidate_context: str, target_role_description: str) -> dict:
    """
